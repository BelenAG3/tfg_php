    ...
    <body >
        ...
        <div class= "container-sm" style="padding-top: 2%;">
            <div class="row">
                        ...
                        <div id="proyector" class="carousel slide" data-bs-ride="carousel" data-interval="30000">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="../info/fred_info1.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/fred_info2.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/fred_info3.jpg" alt="" >
                                </div>
                            </div>
                ...
                <div class="col-sm-7">
                    <h2 style="color: #59C3CE;"><b>Fred</b></h2>
                    <p>Sexo: Macho</p>
                    <p>Edad: Adulto  / Nacimiento: 2023</p>
                    <p>Raza: Gato doméstico de pelaje corto</p>
                    <p>Carácter: Juguetón</p>
                    <p>Refugio: El Refugio</p>
                    <br>
                    <p><b>Su historia</b></p>
                    <p>Es un gatito algo miedoso, aún le cuesta confiar en las personas, pero con paciencia y mucho amor sabemos que será un gato adorable y cariñoso.</p>
                </div>  
            </div>
        </div>
