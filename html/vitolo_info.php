    ...
    <body >
        ...
        <div class= "container-sm" style="padding-top: 2%;">
            <div class="row">
                        ...
                        <div id="proyector" class="carousel slide" data-bs-ride="carousel" data-interval="30000">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="../info/vitolo_info1.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/vitolo_info2.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/vitolo_info3.jpg" alt="" >
                                </div>
                            </div>
                ...
                <div class="col-sm-7">
                    <h2 style="color: #59C3CE;"><b>Vitolo</b></h2>
                    <p>Sexo: Macho</p>
                    <p>Edad: Adulto  / Nacimiento: 2020</p>
                    <p>Raza: Gato atigrado</p>
                    <p>Carácter: Simpático</p>
                    <p>Refugio: El Refugio</p>
                    <br>
                    <p><b>Su historia</b></p>
                    <p>Con el resto de gatos es muy sociable y simpático, disfruta con sus compis con los que juega y se acurruca.</p>
                </div>  
            </div>
        </div>
