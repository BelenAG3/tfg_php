    ...
    <body >
        ...
        <div class= "container-sm" style="padding-top: 2%;">
            <div class="row">
                        ...
                        <div id="proyector" class="carousel slide" data-bs-ride="carousel" data-interval="30000">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="../info/azriel_info1.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/azriel_info2.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/azriel_info3.jpg" alt="" >
                                </div>
                            </div>
                ...
                <div class="col-sm-7">
                    <h2 style="color: #59C3CE;"><b>Azriel</b></h2>
                    <p>Sexo: Hembra</p>
                    <p>Edad: Adulto  / Nacimiento: 2023</p>
                    <p>Raza: Gato negro</p>
                    <p>Carácter: Juguetón</p>
                    <p>Refugio: Asociación Alba</p>
                    <br>
                    <p><b>Su historia</b></p>
                    <p>Es tímida con las personas, pero sabemos que en una familia con cariño y tranquilidad comenzará a confiar y agradecerá mucho las caricias.</p>
                    <p>Es muy sociable y juguetona con el resto de gatitos con los que convive en la gatera.</p>
                </div>  
            </div>
        </div>
