...
<!-- Para indicar que la página web tiene que adaptarse para todos los dispotivos -->
    ...
    <body >
        ...
        <div class="container-sm " style="margin: 5%;">
            <div class="row">
                <div class="col-sm-4">
                    <img src="../sobre_nosotros/sobrenosotros1.PNG" alt="">
                </div>
                <div class="col-sm-4">
                    <img src="../sobre_nosotros/sobrenosotros2.PNG" alt="">
                </div>
                <div class="col-sm-4">
                    <img src="../sobre_nosotros/sobrenosotros3.PNG" alt="">
                </div>
            </div>
        </div>
