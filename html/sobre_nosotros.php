...
<!-- Para indicar que la página web tiene que adaptarse para todos los dispotivos -->
    ...
    <body >
        ...
        <div class= "container-fluid">
                <div class="row">
                    <div class="col-fluid">
                        <img src="../sobre_nosotros/banner_of.PNG" alt="" >
                    </div>
                </div>
        </div>
        ...
        <div class= "container-fluid">
            <div class="row">
                <div class="col-fluid">
                    <h2><b>Pawffé</b></h2>
                    <h3><b>Un verdadero club del gato y del perro</b></h3>
                    <p>Pawffe es un proyecto pionero, que toma su inspiración de las cafetereías con animales japonesas, dándole una vuelta de tuerca al concepto original, para convertirlo en una iniciativa solidaria y de ayuda para gatos y perros.</p>
        ...
        <div class="container-sm ">
            <div class="row justify-content-center">
                <div class="col-sm-4">
                    <img src="../sobre_nosotros/sobrenosotros1.PNG" alt="" class="img-fluid mx-auto d-block">
                </div>
                <div class="col-sm-4">
                    <img src="../sobre_nosotros/sobrenosotros2.PNG" alt="" class="img-fluid mx-auto d-block">
                </div>
                <div class="col-sm-4">
                    <img src="../sobre_nosotros/sobrenosotros3.PNG" alt="" class="img-fluid mx-auto d-block">
                </div>
            </div>
        </div>
        <br></br>
