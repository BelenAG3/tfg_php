    ...
    <body >
        ...
        <div class= "container-sm" style="padding-top: 2%;">
            <div class="row">
                        ...
                        <div id="proyector" class="carousel slide" data-bs-ride="carousel" data-interval="30000">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="../info/rupia_info1.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/rupia_info2.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/rupia_info3.jpg" alt="" >
                                </div>
                            </div>
                ...
                <div class="col-sm-7">
                    <h2 style="color: #59C3CE;"><b>Rupia</b></h2>
                    <p>Sexo: Hembra</p>
                    <p>Edad: Adulto / Nacimiento: 2018</p>
                    <p>Raza: Pastor alemán</p>
                    <p>Carácter: Asustadiza</p>
                    <p>Refugio: Asociación Alba</p>
                    <br>
                    <p><b>Su historia</b></p>
                    <p>Es una perrita con miedos, desconfiada, como un quiero y no puedo, deseando sentir las caricias y afecto pero no se atreve...</p>
                    <p>Busca una casa tranquila, con jardín, fuera de los ruidos de la ciudad y sin niños.</p>
                </div>  
            </div>
        </div>
