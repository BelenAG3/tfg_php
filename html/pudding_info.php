    ...
    <body >
        ...
        <div class= "container-sm" style="padding-top: 2%;">
            <div class="row">
                        ...
                        <div id="proyector" class="carousel slide" data-bs-ride="carousel" data-interval="30000">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="../info/pudding_info1.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/pudding_info2.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/pudding_info3.jpg" alt="" >
                                </div>
                            </div>
                ...
                <div class="col-sm-7">
                    <h2 style="color: #59C3CE;"><b>Pudding</b></h2>
                    <p>Sexo: Macho</p>
                    <p>Edad: Adulto  / Nacimiento: 2018</p>
                    <p>Raza: Domestic long-haired cat</p>
                    <p>Carácter: Asustadizo</p>
                    <p>Refugio: El Refugio</p>
                    <br>
                    <p><b>Su historia</b></p>
                    <p>Es un gatito aún miedoso, no confía mucho en las personas. Estamos seguras de que en un hogar paciente y lleno de amor se convertiría en un gatito completamente diferente.</p>
                    <p>Con el resto de gatitos se lleva súper bien, es muy sociable y le gusta estar acompañado.</p>
                </div>  
            </div>
        </div>
