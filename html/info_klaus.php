    ...
    <body >
        ...
        <div class= "container-sm" style="padding-top: 2%;">
            <div class="row">
                        ...
                        <div id="proyector" class="carousel slide" data-bs-ride="carousel" data-interval="30000">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="../info/klaus_info1.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/klaus_info2.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/klaus_info3.jpg" alt="" >
                                </div>
                            </div>
                ...
                <div class="col-sm-7">
                    <h2 style="color: #59C3CE;"><b>Klaus</b></h2>
                    <p>Sexo: Macho</p>
                    <p>Edad: Adulto / Nacimiento: 2016</p>
                    <p>Raza: Can de palleiro</p>
                    <p>Carácter: Activo</p>
                    <p>Refugio: Asociación Alba</p>
                    <br>
                    <p><b>Su historia</b></p>
                    <p>Este peludo necesita un hogar con experiencia en que trabajen con él y tengan paciencia.</p>
                </div>  
            </div>
        </div>
