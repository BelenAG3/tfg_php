...
<!-- Para indicar que la página web tiene que adaptarse para todos los dispotivos -->
    ...
    <body >
            ...
            <nav class="navbar navbar-expand-sm bg-light navbar-light">
                ...
                <div class="collapse navbar-collapse" id="menuppa2">
                    <ul class="navbar-nav" >
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" style="color: #59C3CE;">Contacto</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-fluid">
                    <img class="f_home" src="../contacto/banner_contacto.PNG" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="container-sm" style="padding-top: 2%;">
            <div class="row">
                <div class="col-sm-7 horario">
                    <h2 style="color: #FFBD59; "><n>Horario:</n></h2>
                    ...
                    <h2 style="color: #FFBD59; "><n>Pawffé</n></h2>
                    <p>C/fffffffffffff</p>
                    <p>28000 Madrid</p>
                ...
                <div class="col-sm-5">
                    <h2 style="color: #FFBD59; ">Dirección:</h2>
