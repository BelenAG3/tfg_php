    ...
    <body >
        ...
        <div class= "container-sm" style="padding-top: 2%;">
            <div class="row">
                        ...
                        <div id="proyector" class="carousel slide" data-bs-ride="carousel" data-interval="30000">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="../info/pitah_info1.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/pitah_info2.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/pitah_info3.jpg" alt="" >
                                </div>
                            </div>
                ...
                <div class="col-sm-7">
                    <h2 style="color: #59C3CE;"><b>Pitah</b></h2>
                    <p>Sexo: Macho</p>
                    <p>Edad: Adulto  / Nacimiento: 2023</p>
                    <p>Raza: Gato siamés</p>
                    <p>Carácter: Independiente</p>
                    <p>Refugio: Asociación Alba</p>
                    <br>
                    <p><b>Su historia</b></p>
                    <p>Es un gatito aún miedoso con las personas, la falta de apego se nota, pero estamos seguras que en un hogar paciente y lleno de amor se convertiría en un gatito más sociable y cariñoso.</p>
                </div>  
            </div>
        </div>
