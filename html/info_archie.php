    ...
    <body >
        ...
        <div class= "container-sm" style="padding-top: 2%;">
            <div class="row">
                        ...
                        <div id="proyector" class="carousel slide" data-bs-ride="carousel" data-interval="30000">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="../info/archie_info1.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/archie_info2.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/archie_info3.jpg" alt="" >
                                </div>
                            </div>
                ...
                <div class="col-sm-7">
                    <h2 style="color: #59C3CE;"><b>Archie</b></h2>
                    <p>Sexo: Macho</p>
                    <p>Edad: Adulto / Nacimiento: 2019</p>
                    <p>Raza: Mastín</p>
                    <p>Carácter: Cariños0</p>
                    <p>Refugio: Asociación Alba</p>
                    <br>
                    <p><b>Su historia</b></p>
                    <p>Con las personas es un auténtico amor, súper noble y cariñoso. Adora los mimos y la compañía.</p>
                </div>  
            </div>
        </div>
