    ...
    <body >
        ...
        <div class= "container-sm" style="padding-top: 2%;">
            <div class="row">
                        ...
                        <div id="proyector" class="carousel slide" data-bs-ride="carousel" data-interval="30000">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="../info/info4.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/info5.jpg" alt="" >
                                </div>
                                <div class="carousel-item">
                                    <img src="../info/info6.jpg" alt="" >
                                </div>
                            </div>
                ...
                <div class="col-sm-7">
                    <h2 style="color: #59C3CE;"><b>Beto</b></h2>
                    <p>Sexo: Macho</p>
                    <p>Edad: Cachorro / Nacimiento: 2024</p>
                    <p>Raza: Jack Russell terrier</p>
                    <p>Carácter: Tranquilo</p>
                    <p>Refugio: Asociación Alba</p>
                    <br>
                    <p><b>Su historia</b></p>
                    <p>Es pura ternura, tan rica y adorable, tan necesitada de encontrar estabilidad, cariño, un hogar para siempre.</p>
                </div>  
            </div>
        </div>
